...
class Articulo extends Model
{
    ...
    protected $fillable = ['producto_nombre', 'foto'];
    /*protected $fillable = [
    ...
    {
        return $this->hasMany(ArticuloUnidad::class, 'articulo_id', 'articulos_cod');
    }

    public function unidadPrincipal()
    {
        return $this->hasOne(ArticuloUnidad::class, 'articulo_id', 'articulos_cod')
