		...
		<div class="modal-content">
			...
			<div class="modal-body">
				<div class="input-group">
	                <input type="text" v-model="txtcliente" @keyup.enter="buscarCliente()" id="txtcliente" class="form-control" placeholder="Buscar por nombre o C.I. ...."/>
                ...
                <table class="table table-sm table-striped table-hover mt-2">
                	...
                	<template v-for="cliente in clientes">
                		<tr>
                			...
                			<td>
                				<button class="btn btn-outline-primary btn-sm" @click="selectCliente(cliente.cliente_ci)" title="Seleccionar">
