                    ...
                    <td>
                        <div class="btn-group">
                            ...
                            <div class="dropdown-menu dropdown-menu-left">
                                <button class="dropdown-item" @click="showDetalle(venta)"><span
                                        class="fa fa-file-alt"></span> Detalle</button>
                                <a :href="'{{ env('APP_URL') }}'+'pdf/boletaventa/'+venta.nro_fact_ventas+'/'"
                                    class="dropdown-item"><span class="fa fa-print"></span> Comprobante</button>
                                    <a :href="'facturar/'+venta.nro_fact_ventas+''" class="dropdown-item"><span
