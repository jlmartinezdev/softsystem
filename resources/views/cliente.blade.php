    ...
    <div class="container" id="app">
        ...
        <div class="row">
            <div class="col-md-2 col-sm-4 mb-2">
                <button class="btn btn-primary" data-toggle="modal" data-target="#agregarCliente"><span
                        class="fa fa-plus"></span> Agregar</button>
            </div>
            <div class="col-md-10 col-sm-6">
                <div class="input-group">
                    <input type="text" v-model="txtbuscar" @keyup.enter="buscar()" class="form-control"
                        placeholder="Buscar...." />
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <button class="btn btn-outline-danger btn-sm"
                                @click="del(cliente.cliente_nombre,cliente.clientes_cod)" title="Seleccionar">
