        ...
        <div class="card">
            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-sm-4">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control form-control-sm" name="descripcion" id="nombre"
                                placeholder="Nombre proveedor" v-model="proveedor.nombre">
                        </div>
                    </div>
                    <div class="col-sm-4">
                        <div class="form-group">
                ...
                <template v-if="band==0">
                    <button class="btn btn-success btn-sm" @click="add"><span class="fa fa-save"></span>
                        Agregar</button>
                </template>
                <template v-else>
                    <button class="btn btn-success btn-sm" @click="update"><span class="fa fa-save"></span>
                        Actualizar</button>
                </template>

                <button class="btn btn-secondary btn-sm" @click="cancelar"><span class="fa fa-times"></span>
                    Cancelar</button>
                                ...
                                <td>
                                    <div class="btn-group">
                                        <button class="btn btn-outline-danger btn-sm"
                                            @click="del({{ $s['PROVEEDOR_cod'] }},'{{ trim($s['proveedor_nombre']) }}')"><span
                                                class="fa fa-trash"></span></button>
                                        <button @click="showEdita({{ $s }})"
        ...
        var app = new Vue({
            ...
            methods: {
                ...
                showEdita: function(p) {
                    ...
                    this.proveedor = {
                        id: p.PROVEEDOR_cod,
                        idnacionalidad: p.nacio_cod,
                        idciudad: p.CIUDAD_cod,
                        nombre: p.proveedor_nombre,
                        direccion: p.proveedor_direc,
                        telefono: p.proveedor_telef,
                        ruc: p.proveedor_ruc
                    };
